...
namespace MvcApp.Data
{
    public class VTInitializer : DropCreateDatabaseIfModelChanges<VTContext>
    {
        protected override void Seed(VTContext context)
        {
            ...
            {
                new Event{Id=1, Name="Toys For Tots", Date=DateTime.Parse("12/12/2018 12:00:00 AM"), StartTime=DateTime.Parse("8:00"), EndTime=DateTime.Parse("12:00"), OrganizationId = 1},
                new Event{Id=2, Name="Blood Drive", Date=DateTime.Parse("11/01/2018"), StartTime=DateTime.Parse("9:00"), EndTime=DateTime.Parse("18:00"), OrganizationId = 2},
                new Event{Id=3, Name="Adoption Event", Date=DateTime.Parse("10/01/2018"), StartTime=DateTime.Parse("10:00"), EndTime=DateTime.Parse("14:00"), OrganizationId = 3},
            };
            ...
            //{
            //    new EventVolunteer{Id=1, EventId=1, VolunteerId=1},
            //    new EventVolunteer{Id=2, EventId=1, VolunteerId=3},
            //    new EventVolunteer{Id=3, EventId=1, VolunteerId=4},
            //    new EventVolunteer{Id=4, EventId=2, VolunteerId=2},
            //    new EventVolunteer{Id=5, EventId=2, VolunteerId=5},
            //    new EventVolunteer{Id=6, EventId=2, VolunteerId=1},
            //    new EventVolunteer{Id=7, EventId=3, VolunteerId=4},
            //    new EventVolunteer{Id=8, EventId=3, VolunteerId=5},
            //    new EventVolunteer{Id=9, EventId=3, VolunteerId=2}
            //};
